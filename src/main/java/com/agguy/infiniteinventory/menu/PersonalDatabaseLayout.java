...
public record PersonalDatabaseLayout(
    ...
    static final int ADVANCED_SEARCH_BUTTON_WIDTH = 40;
    static final int ENHANCEMENT_BUTTON_WIDTH = 48;
    static final int VIEW_SELECTOR_BUTTON_WIDTH = 48;
    static final int TAB_MANAGEMENT_BUTTON_WIDTH = 48;
    static final int SORT_BUTTON_WIDTH = 112;
    static final int DEPOSIT_BUTTON_WIDTH = 88;
    static final int SCOPE_BUTTON_WIDTH = 72;
